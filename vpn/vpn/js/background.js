...
var _BaseFinder = __webpack_require__(13);
    ...
    */
      ...
      */
		...
		value: function getTier(callback) {
			...
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.SERVERSJSON, _ServiceMeta2.default.STORAGEKEYS.BASELINK], function (storage) {
				...
				if (!storageServersJson || storageServersJson && !storageServersJson.hasOwnProperty("nextUpdate") || storageServersJson && storageServersJson.hasOwnProperty("nextUpdate") && storageServersJson.nextUpdate < _Utils2.default.getDateNow()) {
					chrome.runtime.getPlatformInfo(function (platformInfo) {
						var parameter = Object.assign({
							os: platformInfo && platformInfo.os ? platformInfo.os : ""
						}, _this.metaData());
						...
						_this.request(_endpoints2.default.TIER, 'POST', parameter, function (response) {
							if (response && response != "" && response.Retcode === 200 && response.Data && response.Data.hasOwnProperty("mainbase") && Array.isArray(response.Data.mainbase) && response.Data.hasOwnProperty("tierbase") && Array.isArray(response.Data.tierbase)) {
								...
								response.Data.nextUpdate = _Utils2.default.getDateNow() + intervalInSeconds;
								response.Data.mainbase.push('https://' + _ServiceMeta2.default.BACKUPBASEDOMAIN);
								chrome.storage.local.set(_defineProperty({}, _ServiceMeta2.default.STORAGEKEYS.SERVERSJSON, response.Data));
...
var BaseFinder = function () {
   ...
   */
		...
		value: function onInstalled(details) {
			...
			if (details && details.reason && details.reason == 'update' && _this.isEndpointChangeVersion(details.previousVersion)) {
...
var TierUpdater = function () {
  function TierUpdater() {
    ...
    this.updateIntervalTime = 1000 * 60 * 30;
